...
CREATE TABLE `product_features` (
    ...
    `feature_embedding` TEXT NULL COMMENT '功能的文本嵌入向量，以JSON数组或特定格式的文本存储', -- <== 新增字段
...
CREATE TABLE `processed_comments` (
    ...
    `feature_similarity_score` DECIMAL(18, 17) NULL COMMENT '功能模块与文本片段的相似度得分', -- <== 新增字段
